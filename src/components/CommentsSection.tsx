...
import { DiscussionItem } from '../app/(protected)/artwall/post/(discussion-components)/DiscussionItem';
import { DiscussionForm } from '../app/(protected)/artwall/post/(discussion-components)/DiscussionForm';
