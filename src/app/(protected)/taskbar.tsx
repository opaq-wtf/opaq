export function Taskbar() {
    return (
        <div className="w-full h-20 bg-gray-900 text-white flex items-center px-6 shadow fixed bottom-0 left-0 z-50 gap-4">
            <span className="font-semibold">Taskbar</span>
            <form className="ml-4">
                <input
                    type="text"
                    placeholder="Search..."
            ...
            <div className="flex gap-2 ml-auto">
                ...
                <div className="relative group">
                  <button className="rounded-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 transition flex items-center gap-2 w-12 group-hover:w-32 focus:w-32 overflow-hidden duration-300">
                ...
                {/* Dashboard Button */}
                <div className="relative group">
                  <button className="rounded-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 transition flex items-center gap-2 w-12 group-hover:w-36 focus:w-36 overflow-hidden duration-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                {/* Flower Button */}
                <div className="relative group">
                  <button className="rounded-full bg-red-600 hover:bg-red-700 text-white px-4 py-2 transition flex items-center gap-2 w-12 group-hover:w-32 focus:w-32 overflow-hidden duration-300">
