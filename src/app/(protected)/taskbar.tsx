                  ...
                  <button className="rounded-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 transition-all ease-in-out flex items-center gap-2 w-12 sm:group-hover:w-36 sm:focus:w-36 overflow-hidden duration-300">
                    <span className="flex justify-center items-center w-full">
                      <svg
                        ...
                        className="h-5 w-5 flex-shrink-0 text-blue-20012"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
                      >
                        <path
                          d="M7 3h10M9 3v6.132a2 2 0 0 1-.553 1.38l-3.894 4.05A4 4 0 0 0 8.5 21h7a4 4 0 0 0 3.947-6.438l-3.894-4.05A2 2 0 0 1 15 9.132V3"
                          stroke="currentColor"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <span className="whitespace-nowrap opacity-0 sm:group-hover:opacity-100 sm:group-focus:opacity-100 transition-opacity duration-200 pr-8">
                      Studio
                    </span>
                  </button>
                </div>
