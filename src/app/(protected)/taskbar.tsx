    ...
    <div className="w-full bg-gray-900 text-white shadow fixed bottom-0 left-0 z-50">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full h-auto sm:h-20 px-4 py-2">
        ...
        <div className="flex justify-center sm:justify-end w-full sm:w-auto">
          <div className="flex flex-row gap-3 w-full sm:w-auto overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 justify-center">
            {/* Feed Button */}
            <div className="relative group">
              ...
              <Link
                href="/home"
                className={`rounded-full bg-gray-600 hover:bg-gray-700 text-blue-100 px-4 py-2 transition-all ease-in-out flex items-center gap-2 w-12 sm:group-hover:w-36 sm:focus:w-36 overflow-hidden duration-300 ${pathname === "/home" ? "sm:w-36" : ""}`}
              >
                ...
                <span
                  className={`whitespace-nowrap opacity-0 sm:group-hover:opacity-100 sm:group-focus:opacity-100 transition-opacity duration-200 pr-8 ${pathname === "/home" ? "sm:opacity-100" : ""}`}
                >
                  Home
                </span>
              </Link>
            ...
            <div className="relative group">
              <Link
                href="/artwall"
                className={`rounded-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 transition-all ease-in-out flex items-center gap-2 w-12 sm:group-hover:w-36 sm:focus:w-36 overflow-hidden duration-300 ${pathname === "/artwall" ? "sm:w-36" : ""}`}
              >
                <span className="flex justify-center items-center w-full">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span
                  className={`whitespace-nowrap text-white opacity-0 sm:group-hover:opacity-100 sm:group-focus:opacity-100 transition-opacity duration-200 pr-8 ${pathname === "/artwall" ? "sm:opacity-100" : ""}`}
                >
                  Artwall
                </span>
              </Link>
            ...
            <div className="relative group">
              ...
              <Link
                href="/bloom"
                className={`rounded-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 transition-all ease-in-out flex items-center gap-2 w-12 sm:group-hover:w-36 sm:focus:w-36 overflow-hidden duration-300 ${pathname === "/bloom" ? "sm:w-36" : ""}`}
              >
                <span className="flex justify-center items-center w-full">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span
                  className={`whitespace-nowrap opacity-0 sm:group-hover:opacity-100 sm:group-focus:opacity-100 transition-opacity duration-200 pr-8 ${pathname === "/bloom" ? "sm:opacity-100" : ""}`}
                >
                  Bloom
                </span>
              </Link>
            ...
            <div className="relative group">
              ...
              >
                <span className="flex justify-center items-center w-full relative">
                  ...
                  {/* Sparkling stars */}
                  <svg
                    className="absolute left-0 top-0 w-2 h-2 animate-pulse text-yellow-200"
                    fill="currentColor"
                    viewBox="0 0 8 8"
                  >
                  ...
                  <svg
                    className="absolute right-0 bottom-0 w-1.5 h-1.5 animate-ping text-yellow-100"
                    fill="currentColor"
                    viewBox="0 0 8 8"
                  >
                    <polygon points="4,0 5,3 8,4 5,5 4,8 3,5 0,4 3,3" />
                  ...
                  <svg
                    className="absolute right-1 top-0 w-1 h-1 animate-pulse text-white"
                    fill="currentColor"
                    viewBox="0 0 8 8"
                  >
                    <polygon points="4,0 5,3 8,4 5,5 4,8 3,5 0,4 3,3" />
