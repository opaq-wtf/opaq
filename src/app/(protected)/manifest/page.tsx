...
export default function ManifestPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-10rem)] w-full flex-col items-center justify-center bg-gray-950 text-white p-4">
      <div className="w-full max-w-3xl text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-10 grid gap-4">
          ...
          <button
            type="submit"
            className="inline-flex w-full items-center justify-center rounded-md bg-yellow-400 px-6 py-3 text-lg font-semibold text-gray-900 shadow-lg transition-transform duration-200 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2 focus:ring-offset-gray-950 disabled:opacity-50"
          >
